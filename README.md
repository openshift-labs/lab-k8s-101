Lab - Hands On Intro to Kubernetes
====================

Kubernetes 101 workshop environment
...
When deployed the name of the deployment will be `lab-k8s-101`.

You can determine the hostname for the URL to access the workshop by running:

```
oc get route lab-k8s-101
```
